import {checkCanvasSize, simulateMousePosition,
        getShapes, TestResults, advanceToFrame, TestRectangle, checkBackgroundIsCalledInDraw, testShapesMatchInOrder, canvasStatus } from "https://cdn.jsdelivr.net/gh/Supportive-IDE/p5js-testing-demo@latest/p5jsTestingLibrary.js";
...
async function runTests(canvas) {
    ...
    if (actualShapes.length === 0) {
        ...
        await testFrame(300, 300);
        await testFrame(0, 160);
        await testFrame(400, 10);
    }
